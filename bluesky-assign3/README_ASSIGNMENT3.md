...
- unused_data/synthetic_data.csv and unused_data/x_posts_data.csv are data we collected from X and synthetic data we created but did not use in the final project implementation. 
